      ...
      <div className='relative w-full flex flex-wrap xl:flex-nowrap bg-white py-10 px-4 xl:px-0'>
        <div className='flex flex-col w-full mb-10 xl:mb-0'>
          <div className='w-full'>
            <h1 className='text-2xl sm:text-4xl md:text-5xl text-blue-500 mb-2 font-bold'>MY RANDOM RAMBLINGS</h1>
            <h2 className='text-lg sm:text-2xl text-black mb-10'>This page is for my thoughts on random topics and listing all my favourite films, series, games and anime, so you could better get to know me.</h2>
