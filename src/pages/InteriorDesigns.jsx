...
import '../gallery.css'
import data from '../data/interiordesigns'
import Modal from '../components/Modal'
import HeaderPicture from '../assets/interiordesignsheader.jpg'
...
function InteriorDesigns() {
  ...
  return (
  <div name='InteriorDesigns' className='w-full h-screen bg-gray-900'>
      <Navbar />
      ...
      <div className='relative w-full h-1/4 mx-auto flex justify-center'>
        ...
        <h1 className='absolute text-center mt-[90px] sm:mt-[75px] min-[400px]:text-4xl text-3xl sm:text-7xl font-bold text-blue-200 cursor-default'>Interior designs</h1>
      </div>
