...
import HeaderPicture from '../assets/traditionalgalleryheader.jpg'
...
function TraditionalGallery() {
  ...
  return (
  <div name='TraditionalGallery' className='w-full h-screen bg-gray-900'>
      <Navbar />
      ...
      <div className='relative w-full h-1/4 mx-auto flex justify-center'>
        ...
        <h1 className='absolute text-center mt-[90px] sm:mt-[75px] min-[400px]:text-4xl text-3xl sm:text-7xl font-bold text-blue-200 cursor-default'>Traditional Gallery</h1>
      </div>
