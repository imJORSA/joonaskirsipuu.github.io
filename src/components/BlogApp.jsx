      ...
      <div className='relative w-full flex flex-wrap xl:flex-nowrap bg-white py-8 px-4 xl:px-0'>
        <div className='flex flex-col w-full mb-10 xl:mb-0'>
          <div className='w-full'>
            <h1 className='text-xl sm:text-4xl md:text-5xl text-blue-500 pb-4 font-bold'>{t('blog_page.title')}</h1>
            <h2 className='text-sm sm:text-2xl text-black mb-10'>{t('blog_page.subtitle')}</h2>
            <ul className='flex flex-col gap-8 list-none pl-0'>
              <li className='text-sm sm:text-2xl font-bold px-0'>
